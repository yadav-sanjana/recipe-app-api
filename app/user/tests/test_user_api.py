...
class PublicUserApiTests(TestCase):
    ...
    def test_create_user_token(self):
        """create user token for valid credential"""
        user_details = {
            'email': 'test@example.com',
            'name': 'Test name',
            'password': 'sample123'
    ...
    def test_create_token_bad_credential(self):
        """user token generates error for bad credential"""
    ...
    def test_create_token_blank_password(self):
        """test posting a blank password raise error"""
    ...
    def test_retrieve_user_unauthorized(self):
        """Test authentication is required for retreive user details"""
...
class PrivateUserApiTests(TestCase):
    ...
    def test_post_me_not_allowed(self):
        """the POST is not not allowed for me endpoint"""
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'updated name', 'password': 'updated_password123'}
